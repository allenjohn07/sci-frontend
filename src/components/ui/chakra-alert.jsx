  ...
  return (
    <Alert.Root className="my-6">
        <Alert.Title>
          ...
          organized by SCI. If you have aleady participated in any SCI
          competition and if your name is not there in the ranking list, please
          claim your state by sending an email to{" "}
          <a
